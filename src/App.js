...
import { addOne, applyNumber, changeOperation, clearDisplay, saveMemory, applyMemory, clearMemory } from './actions/index'
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() =>dispatch(saveMemory())}/>
              <CalcButton value={"MR"} onClick={()=>dispatch(applyMemory())}/>
              <CalcButton value={"MC"} onClick={()=>dispatch(clearMemory())}/>
            </div>

            <div className="row">
              <CalcButton value={1} onClick={()=>dispatch(applyNumber(1))/*()=>dispatch(addOne())*/}/>
